...
# readr::write_csv(monetary_poverty, "data/interim/cross-sectional/02-monetary-poverty.csv")
...
#   dplyr::filter(stringr::str_sub(ubigeo, 1, 4) %in% c("0701", "1501"))
# readr::write_csv(nonmonetary_poverty, "data/interim/cross-sectional/03-nonmonetary-poverty.csv")
